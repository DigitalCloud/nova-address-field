...
var render = function() {
  ...
  return _c("span", { staticClass: "text-90" }, [
    _vm._v(_vm._s(_vm.addressData.formatted_address) + " "),
    _c("br"),
    _vm._v(
      " (" +
        _vm._s(_vm.addressData.latitude.toFixed(6)) +
        ", " +
        _vm._s(_vm.addressData.longitude.toFixed(6)) +
        ")"
    )
  ])
}
  ...
  return _c("div", { staticClass: "flex border-b border-40" }, [
    ...
    _c("div", { staticClass: "w-3/4 py-4" }, [
      _c("p", { staticClass: "text-90" }, [
        _vm._v(
          _vm._s(_vm.addressData.formatted_address) +
            " | (" +
            _vm._s(_vm.addressData.latitude.toFixed(6)) +
            ", " +
            _vm._s(_vm.addressData.longitude.toFixed(6)) +
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_google_autocomplete__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_google_autocomplete___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vue_google_autocomplete__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { VueGoogleAutocomplete: __WEBPACK_IMPORTED_MODULE_2_vue_google_autocomplete___default.a },
    ...
    mounted: function mounted() {
        ...
        if (this.field.do_not_store) {
            this.$parent.$children.forEach(function (component) {
                console.log('component.field.name ===>', component.field.name);
                if (component.field && [_this2.field.latitude_field, _this2.field.longitude_field, _this2.field.address_field, _this2.field.administrative_area_level_1].includes(component.field.attribute)) {
                    var comp = component;
                    var watcher = component.$watch('value', function (value) {
                        _this2.relatedValues[comp.field.attribute] = value;
                        if (_this2.addressIsInitializing) {
                            _this2.initializeAddress();
                        }
                    });
                    if (component.field.attribute === _this2.field.address_field) {
    ...
    methods: {
        getAddressComponent: function getAddressComponent(address_components, component) {
            ...
            if (short) {
                // short name
                if (_typeof(res.address_components) == 'object' && res.address_components[0].hasOwnProperty('short_name')) {
                    return res.address_components[0].short_name;
                }
                return res.short_name;
            } else {
                // long name
                if (_typeof(res.address_components) == 'object' && res.address_components[0].hasOwnProperty('long_name')) {
                    return res.address_components[0].long_name;
                }
                return res.long_name;
            }
        },
        getFirstOccurenceOfComponent: function getFirstOccurenceOfComponent(results, component) {
            var address_components = results.map(function (e) {
                return e.address_components;
            });
        ...
        initializeAddress: function initializeAddress() {
            if (this.field.address_field && this.relatedValues[this.field.address_field]) {
                var v = this.relatedValues[this.field.address_field];
                if (this.field.address_field_array_key) {
        ...
        refreshMap: function refreshMap() {
            ...
            var LatLng = new google.maps.LatLng(this.addressData.latitude, this.addressData.longitude);
        ...
        geocode: function geocode(latLng) {
            var _this = this;
        ...
        updateTimeZoneField: function updateTimeZoneField() {
            var _this3 = this;

            this.$nextTick(function () {
                Nova.$emit(_this3.field.timezone + '-value', _this3.addressData.timeZoneName);
            });
        },
        updateFields: function updateFields(addressData) {
            ...
            this.$nextTick(function () {
                Nova.$emit(_this4.field.countryCode + '-value', addressData.countryCode);
                Nova.$emit(_this4.field.country + '-value', addressData.country);
                Nova.$emit(_this4.field.locality + '-value', addressData.locality);
                console.log('state:', addressData.administrative_area_level_1);
                console.log('relatedValues:', _this4.relatedValues);
                Nova.$emit(_this4.field.administrative_area_level_1 + '-value', addressData.administrative_area_level_1);
                var name = addressData.formatted_address;
                if (_this4.field.address_field_array_key) {
                    name = {};
                    name[_this4.field.address_field_array_key] = addressData.formatted_address;
                }

                Nova.$emit(_this4.field.address_field + '-value', name);
                Nova.$emit(_this4.field.postal_code + '-value', addressData.postal_code);
            });
        },
        updateGeoLocationFields: function updateGeoLocationFields(addressData) {
            ...
            this.$nextTick(function () {
                Nova.$emit(_this5.field.latitude_field + '-value', addressData.latitude);
                Nova.$emit(_this5.field.longitude_field + '-value', addressData.longitude);
            });
        }
    },
    ...
    watch: {
        'addressData': {
            handler: function () {
                var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(newAddressData) {
                    var response;
                        ...
                        while (1) {
                            switch (_context.prev = _context.next) {
                                case 0:
                                    ...
                                    _context.next = 7;
                                    return Nova.request().get('/api/v1/nova/timezone/' + newAddressData.latitude + '/' + newAddressData.longitude);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a72a90ea", Component.options)
  } else {
    hotAPI.reload("data-v-a72a90ea", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    methods: {
        ...
        updateCoordinates: function updateCoordinates(value) {
            ...
            this.geolocation.geocoder.geocode({ 'location': value }, function (results, status) {
                console.log('About to call filterGeocodeResultTypes');
                if (status === 'OK') {
        ...
        filterGeocodeResultTypes: function filterGeocodeResultTypes(results) {
            console.log('we are in filterGeocodeResultTypes');
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-a72a90ea", module.exports)
  }
}
